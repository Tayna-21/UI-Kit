				...
				<div className={styles.content}>
					<div className={styles.month}>
						...
						<div className={styles.switcher}>
					        <button type='button' onClick={getPreviousMonth}><ChevronLeftIcon /></button>
					        <button type='button' onClick={getNextMonth}><ChevronRightIcon /></button>
						</div>
				    </div>
				    <div className={styles.dates}>
						...
						{days.map((day, index) => (
							...
							>
								<button type='button' className={styles.button} onClick={() => selectDay(day)}>
								    <time 
									    className={`
											${styles.day}
